...
function changeTimerValue(timerField, timerFinish) {
  ...
  if (timeRemain <= 0) {
    ...
    serverused = window.location.host; //let newurl = window.location.protocol + '//' + serverused + '/sites/' + node.id + '/edit'

    alert(serverused); //windows.location = result_test_passage_path(@test_passage)
  }
}
...
/******/ });
//# sourceMappingURL=application-79c491604a1af8f437e2.js.map
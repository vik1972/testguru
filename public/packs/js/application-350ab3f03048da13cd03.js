...
function changeTimerValue(timerField, timerFinish) {
  ...
  if (timeRemain <= 0) {
    ...
    window.location.href = '/test_passages/' + testId + '/result'; //let timerId =setTimeout(function(){alert('444')}, 1000)
...
/******/ });
//# sourceMappingURL=application-350ab3f03048da13cd03.js.map
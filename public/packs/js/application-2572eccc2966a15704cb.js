...
function changeTimerValue(timerField, timerFinish) {
  ...
  if (timeRemain <= 0) {
    ...
    clearTimeout(timerId); //document.location.href = controller.redirect_to result_test_passage_path(@test_passage) }, 100)
  }
}
...
/******/ });
//# sourceMappingURL=application-2572eccc2966a15704cb.js.map
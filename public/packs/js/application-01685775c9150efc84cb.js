...
function changeTimerValue(timerField, timerFinish) {
  ...
  if (timeRemain <= 0) {
    timerField.textContent = "00:00"; //setTimeout(function(){ window.location = result_test_passage_path(@test_passage) }, 1000)
  }
}
...
/******/ });
//# sourceMappingURL=application-01685775c9150efc84cb.js.map
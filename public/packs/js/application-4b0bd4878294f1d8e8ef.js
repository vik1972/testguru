...
function changeTimerValue(timerField, timerFinish) {
  ...
  if (timeRemain <= 0) {
    ...
    serverused = window.location.host; //let newurl = window.location.protocol + '//' + serverused + '/test_passages/'  + '/result'
    //alert(@test_passage)
...
/******/ });
//# sourceMappingURL=application-4b0bd4878294f1d8e8ef.js.map